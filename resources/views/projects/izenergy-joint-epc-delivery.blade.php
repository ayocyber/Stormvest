...
@section('content')
    ...
    <section class="relative h-[250px] md:h-[280px] flex flex-col justify-end px-10 lg:px-16 pb-8 overflow-hidden">
        ...
        <div class="relative z-10 max-w-6xl mx-auto w-full text-center">
            <h1 class="text-2xl md:text-4xl font-semibold tracking-tight text-white mb-3">Izenergy Joint EPC Delivery</h1>
    ...
    <section class="px-10 lg:px-16 max-w-6xl mx-auto pb-20 grid md:grid-cols-2 gap-10 items-start">
        ...
        {{-- Key features --}}
        <div class="space-y-4">
            <p class="text-lg text-[#1D1D1D]"><strong>Izenergy Joint EPC Delivery | 1.2 MWp</strong></p>
            <p class="text-base text-gray-600"><strong class="text-[#1D1D1D]">Project Name:</strong> Izenergy Joint EPC Delivery</p>
            ...
            <p class="text-base text-gray-600"><strong class="text-[#1D1D1D]">Location:</strong> Abuja, FCT, Nigeria</p>
            <p class="text-base text-gray-600"><strong class="text-[#1D1D1D]">Model:</strong> Engineering, Procurement and Construction</p>
            <p class="text-base text-gray-600"><strong class="text-[#1D1D1D]">Size:</strong> 1.2 MWp</p>
