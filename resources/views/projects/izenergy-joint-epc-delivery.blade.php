...
@section('title', 'Izenergy Joint EPC Delivery - StormVest Solar Energy')

@section('content')

    {{-- HERO --}}
    <section class="relative h-[500px] md:h-[560px] flex flex-col justify-end px-10 lg:px-16 pb-14 overflow-hidden">
        <img src="{{ asset('images/projects/izenergy.jpg') }}" alt="Izenergy Joint EPC Delivery" class="absolute inset-0 w-full h-full object-cover">
        <div class="absolute inset-0 bg-black/60"></div>
        <div class="relative z-10 max-w-6xl mx-auto w-full text-center">
            <h1 class="text-[40px] md:text-[64px] font-semibold tracking-[-2px] leading-[1.2] text-white mb-6">Izenergy Joint EPC Delivery</h1>
    ...
    <section class="px-10 lg:px-16 py-20 max-w-6xl mx-auto">
        <h3 class="text-3xl md:text-4xl font-normal max-w-5xl leading-snug text-[#1D1D1D]">
            A Large-Scale EPC Solar Project Jointly Executed By StormVest Solar Energy And Izenergy, Delivering Reliable Institutional-Grade Power To A Commercial Facility In Abuja.
        </h3>
    </section>
    ...
    <section class="px-10 lg:px-16 max-w-6xl mx-auto pb-24 grid md:grid-cols-2 gap-10 items-start">
        ...
        <div class="relative rounded-2xl overflow-hidden aspect-[4/3.7]">
            <img src="{{ asset('images/projects/izenergy.jpg') }}" alt="Izenergy Joint EPC Delivery" class="w-full h-full object-cover">
        ...
        {{-- Key features --}}
        <div class="space-y-5">
            <p class="text-xl text-[#1D1D1D]"><strong>Izenergy Joint EPC Delivery | 1.2 MWp</strong></p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Project Name:</strong> Izenergy Joint EPC Delivery</p>
            ...
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Location:</strong> Abuja, FCT, Nigeria</p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Model:</strong> Engineering, Procurement and Construction</p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Size:</strong> 1.2 MWp</p>
