...
@section('content')
    ...
    <section class="relative h-[250px] md:h-[280px] flex flex-col justify-end px-10 lg:px-16 pb-8 overflow-hidden">
        ...
        <div class="relative z-10 max-w-6xl mx-auto w-full text-center">
            <h1 class="text-2xl md:text-4xl font-semibold tracking-tight text-white mb-3">Megaloite Industrial Power Station</h1>
    ...
    <section class="px-10 lg:px-16 max-w-6xl mx-auto pb-20 grid md:grid-cols-2 gap-10 items-start">
        ...
        {{-- Key features --}}
        <div class="space-y-4">
            <p class="text-lg text-[#1D1D1D]"><strong>Megaloite Industrial Power Station | 2 MWp</strong></p>
            <p class="text-base text-gray-600"><strong class="text-[#1D1D1D]">Project Name:</strong> Megaloite Industrial Power Station</p>
            <p class="text-base text-gray-600"><strong class="text-[#1D1D1D]">Type of Project:</strong> Industrial</p>
            <p class="text-base text-gray-600"><strong class="text-[#1D1D1D]">Service:</strong> EPC Project Delivery</p>
            <p class="text-base text-gray-600"><strong class="text-[#1D1D1D]">Location:</strong> Port Harcourt, Rivers State, Nigeria</p>
            <p class="text-base text-gray-600"><strong class="text-[#1D1D1D]">Model:</strong> Engineering, Procurement and Construction</p>
            <p class="text-base text-gray-600"><strong class="text-[#1D1D1D]">Size:</strong> 2 MWp</p>
