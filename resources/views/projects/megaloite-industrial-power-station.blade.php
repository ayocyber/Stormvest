...
@section('title', 'Megaloite Industrial Power Station - StormVest Solar Energy')

@section('content')

    {{-- HERO --}}
    <section class="relative h-[500px] md:h-[560px] flex flex-col justify-end px-10 lg:px-16 pb-14 overflow-hidden">
        <img src="{{ asset('images/projects/megaloite.jpg') }}" alt="Megaloite Industrial Power Station" class="absolute inset-0 w-full h-full object-cover">
        <div class="absolute inset-0 bg-black/60"></div>
        <div class="relative z-10 max-w-6xl mx-auto w-full text-center">
            <h1 class="text-[40px] md:text-[64px] font-semibold tracking-[-2px] leading-[1.2] text-white mb-6">Megaloite Industrial Power Station</h1>
    ...
    <section class="px-10 lg:px-16 py-20 max-w-6xl mx-auto">
        <h3 class="text-3xl md:text-4xl font-normal max-w-5xl leading-snug text-[#1D1D1D]">
            A 2MW Industrial Solar Power Station Built For One Of Nigeria's Active Construction And Project Delivery Companies. Delivered By StormVest In Partnership With Megaloite Projects.
        </h3>
    </section>
    ...
    <section class="px-10 lg:px-16 max-w-6xl mx-auto pb-24 grid md:grid-cols-2 gap-10 items-start">
        ...
        <div class="relative rounded-2xl overflow-hidden aspect-[4/3.7]">
            <img src="{{ asset('images/projects/megaloite.jpg') }}" alt="Megaloite Industrial Power Station" class="w-full h-full object-cover">
        ...
        {{-- Key features --}}
        <div class="space-y-5">
            <p class="text-xl text-[#1D1D1D]"><strong>Megaloite Industrial Power Station | 2 MWp</strong></p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Project Name:</strong> Megaloite Industrial Power Station</p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Type of Project:</strong> Industrial</p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Service:</strong> EPC Project Delivery</p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Location:</strong> Port Harcourt, Rivers State, Nigeria</p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Model:</strong> Engineering, Procurement and Construction</p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Size:</strong> 2 MWp</p>
        ...
        <div class="grid sm:grid-cols-3 gap-8">
            <a href="/projects/zee-realty-estate-solar-hub" class="group relative rounded-2xl overflow-hidden aspect-[4/5]">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-7">
                    <h4 class="text-white font-bold text-2xl leading-snug">Zee Realty Estate Solar Hub</h4>
                </div>
            </a>
