...
@section('content')
    ...
    <section class="relative h-[500px] md:h-[560px] flex flex-col justify-end px-10 lg:px-16 pb-14 overflow-hidden">
        ...
        <div class="relative z-10 max-w-6xl mx-auto w-full text-center">
            <h1 class="text-[40px] md:text-[64px] font-semibold tracking-[-2px] leading-[1.2] text-white mb-6">FCMB Headquarters Solar Retrofit</h1>
    ...
    <section class="px-10 lg:px-16 max-w-6xl mx-auto pb-24 grid md:grid-cols-2 gap-10 items-start">
        ...
        {{-- Key features --}}
        <div class="space-y-5">
            <p class="text-xl text-[#1D1D1D]"><strong>FCMB Headquarters Solar Retrofit | 500 kWp</strong></p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Project Name:</strong> FCMB Headquarters Solar Retrofit</p>
            ...
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Location:</strong> Victoria Island, Lagos, Nigeria</p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Model:</strong> Engineering, Procurement and Construction</p>
            <p class="text-lg text-gray-600"><strong class="text-[#1D1D1D]">Size:</strong> 500 kWp</p>
